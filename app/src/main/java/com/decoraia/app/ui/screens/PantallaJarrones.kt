...
@Composable
fun PantallaJarrones(navController: NavHostController, style: String) {
    Scaffold(
        topBar = {
            TopAppBar(
                title = { Text("Jarrones • $style") },
                navigationIcon = {
