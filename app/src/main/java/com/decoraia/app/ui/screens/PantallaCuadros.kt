...
private data class CuadroItem(
    val id: String,
    val title: String,
    val modelUrl: String
)

private val cuadros = listOf(
    CuadroItem(
        id = "cuadro_abstracto",
...
@Composable
fun PantallaCuadros(navController: NavHostController, style: String) {
    Scaffold(
        topBar = {
            TopAppBar(
                title = { Text("Cuadros • $style") },
                navigationIcon = {
